        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li><a href="mailto:contact@gulfcustoms.com" className="hover:text-brand-cyan">contact@gulfcustoms.com</a></li>
              <li><a href="tel:+1234567890" className="hover:text-brand-cyan">(123) 456-7890</a></li>
              <li>123 Luxury Lane, Dubai, UAE</li>
            </ul>
          </div>
          <div>
